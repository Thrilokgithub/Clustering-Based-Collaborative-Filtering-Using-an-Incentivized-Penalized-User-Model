...
<head>
<title>All Recieved Request</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2> All Reciever Requests of <span class="style2"> <%=application.getAttribute("user")%></span></h2>
          ...
          <div class="clr"></div>
            ...
            <p>
					  ...
					  try{
				                String user="",from="",date="",status="",dob="",contact="",location="",community="";

								int i=0,id=0,count=1,count1=1;;
				                
								user = (String)application.getAttribute("user");
				              
								String str1 = "select * from requests where reqto='"+user+"' ";
		  ...
		  <table width="655" border="1"  cellpadding="0" cellspacing="0"   font-size:14px;">
            <tr>
              ...
              <td  width="103" height="28" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8 style6 style10 style15"><strong>Sender Image</strong></div></td>
              <td  width="103" height="28" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8 style6 style10 style15"><strong>Requested from</strong></div></td>
              <td  width="101" height="28" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8 style6 style10 style15"><strong>Date </strong></div></td>
			  ...
			  <td  width="101" height="28" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style8 style6 style10 style15"><strong>Status</strong></div></td>
            <tr>
									<%
									}
									id = rs1.getInt(1);
									...
									String str2 = "Select * from user where username = '"+from+"' ";
            ...
            <tr>
						...
						%>
             <td  valign="baseline" height="0"><div align="center" class="style16 style11 style6">
						  <p><a href="user_Request_Status.jsp?id=<%=id%>">Waiting</a></p>
						  <p>&nbsp; </p>
						</div></td>
              <%
						}
