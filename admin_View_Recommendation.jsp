...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style23">All Users Recommendations Post</span> <span class="style20"><%=request.getParameter("name")%></span></span></h2>
 ...
 <table width="623" border="1"  cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style22 style21" style="margin-left:20px;"><strong>User Domain</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s2%></span></td>
   </tr>
   <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Post Name </strong></div></td>
     <td width="202"><span class="style21"> &nbsp;&nbsp;<%=s3%></span></td>
   </tr>
   <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Color </strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s4%></span></td>
   </tr>
   <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Discription</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Desc%></span></td>
   </tr>
   <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Uses</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Uses%></span></td>
   </tr>
   
    <tr>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style22 style21" style="margin-left:20px;"><strong>Rank</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=j%></span></td>
   </tr>
   <tr>
     <td   width="186" height="62" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style21 style22" style="margin-left:20px;"><strong>Rating</strong></div                        ></td>
    ...
    %>
      ...
      <%
	  String str4 = "select * from recommendations where post_name='"+name+"' ";
	  ...
	  while(rs4.next())
	  {
	   ...
	   %>
	   <tr>
	  <td  width="227" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Recommended _from </strong></div></td>
     <td  width="186" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong><span class="style21" style="margin-left:20px;">Recommended</span>_To</strong></div></td>
	 <td  width="202" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Details</strong></div></td>
	   </tr>
	   <%
	   }
	   %> 
     ...
     <td width="186"><span class="style21"> &nbsp;&nbsp;<%=review%></span></td>
	 <td width="202"><span class="style21"> &nbsp;&nbsp;<%=date%></span></td>
	   </tr>
	   <%
	 ...
	 <td width="202"><span class="style21"></td>
	   ...
	   <%
          ...
          <p>&nbsp;</p>
          <p align="right"><a href="admin_All_Recommended_Posts.jsp">Back</a></p>
          <div class="clr"></div>
        </div>
        <div class="article">
