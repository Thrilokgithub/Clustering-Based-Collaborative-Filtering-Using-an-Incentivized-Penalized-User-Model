...
<!--
.style1 {color: #FFFFFF}
.style5 {color: #7e7e7e; font-size: 16px; }
.style6 {color: #5286bc}
.style7 {
	color: #FF0000;
	font-weight: bold;
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style7">User  Registration....</h2>
...
<%@ page import="com.oreilly.servlet.*"%>
            ...
            <%
					...
					if ( rs1.next() )
					   {
					   		%><p class="style8">User name <%=uname%> Already Exists</p>
            <%
							
							
				%>
							<p><a href="user_Register.jsp">Back</a></p>
				<%
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,pincode,status,image,location,community) values(?,?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0)
						{
							%><p class="style5"><span class="style7">User name <%=uname%> Registered Successfully in User Domain</span> <span class="style6"> <%=community%></span></p>
				<%
