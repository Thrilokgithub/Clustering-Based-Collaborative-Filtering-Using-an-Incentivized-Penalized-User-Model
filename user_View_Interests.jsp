...
<div class="main">
 ...
 <table width="574" border="1"  cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left " class="style19 style22" style="margin-left:20px;">User Domain</div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s2%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style19 style22" style="margin-left:20px;">Post Name </div></td>
     <td width="175"><span class="style21"> &nbsp;&nbsp;<%=s3%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style19 style22" style="margin-left:20px;">Color </div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s4%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style19 style22" style="margin-left:20px;">Discription</div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Desc%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style19 style22" style="margin-left:20px;">Uses</div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Uses%></span></td>
   </tr>
   
    <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left " class="style19 style22" style="margin-left:20px;">Rank</div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=j%></span></td>
   </tr>
   <tr>
     <td   width="164" height="62" align="left" valign="middle" bgcolor="#FFFF00" style="color: #2c83b0;"><div align="left" class="style19 style22" style="margin-left:20px;">Rating</div                        ></td>
    ...
    %>
	  ...
	  while(rs4.next())
	  {
	   ...
	   %>
	   <tr>
	  <td  width="227" valign="middle" height="30" style="color: #2c83b0;"><div align="left" class="style21  style19 style20" style="margin-left:20px;">Reviewed By</div></td>
     <td  width="164" valign="middle" height="30" style="color: #2c83b0;"><div align="left" class="style21  style19 style20" style="margin-left:20px;">Review</div></td>
	 <td  width="175" valign="middle" height="30" style="color: #2c83b0;"><div align="left" class="style21  style19 style20" style="margin-left:20px;">Date</div></td>
	   </tr>
	   <%
	   }
	   %> 
	 ...
	 <td width="175"><span class="style21"></td>
	   ...
	   <%
       	...
       	out.println("");
            ...
            <p align="right"><a href="user_User_Interests.jsp">Back</a></p>
