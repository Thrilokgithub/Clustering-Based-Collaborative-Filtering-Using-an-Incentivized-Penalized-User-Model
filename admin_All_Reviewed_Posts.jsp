...
<head>
<title>All Reviewed Posts </title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style9">
        <div class="article">
          <h2 class="style8">All Reviewed Posts by Clustering-Based Collaborative Filtering.</h2>
...
<table width="260" border="0" align="center">
  <tr>
    <td width="119" bgcolor="#FF0000"><div align="left" class="style2 style1 style5">
      <div align="center">Post Name</div>
    </div></td>
    <td width="131"><div align="left"><%=name%></div></td>
  </tr>
  
  <tr>
    <td bgcolor="#FF0000"><div align="left" class="style2 style1 style6">
      <div align="center"> Color</div>
    </div></td>
    <td><div align="left"><%=color%></div></td>
  </tr>
  <tr>
    <td bgcolor="#FF0000"><div align="left" class="style2 style1 ">
      <div align="center">View Post  </div>
    </div></td>
    <td><div align="left" class="style8">
      <div align="left"><a href="admin_View_Interests.jsp?name=<%=name%>">View&nbsp;</a></div>
    </div></td>
  </tr>
</table>
...
out.println("---------------------------------------------------------------------------");
	  if(count==1)
		   {
		   %><p>Name of User Domain : <%=community%></p><%
		   count=count+1;
		   }
	   }
          }
