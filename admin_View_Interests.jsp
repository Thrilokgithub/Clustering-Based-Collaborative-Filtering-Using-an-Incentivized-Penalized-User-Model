...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>All Users Interests Post <span class="style20"><%=request.getParameter("name")%></span></span></h2>
 ...
 <table width="574" border="1"  cellpadding="0" cellspacing="0"  >
   ...
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style22 style21" style="margin-left:20px;"><strong>User Domain</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s2%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Post Name </strong></div></td>
     <td width="175"><span class="style21"> &nbsp;&nbsp;<%=s3%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Color </strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=s4%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Discription</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Desc%></span></td>
   </tr>
   <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Uses</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=decrypted_Uses%></span></td>
   </tr>
   
    <tr>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left " class="style22 style21" style="margin-left:20px;"><strong>Rank</strong></div></td>
     <td><span class="style21">&nbsp;&nbsp;<%=j%></span></td>
   </tr>
   <tr>
     <td   width="164" height="62" align="left" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style21 style22" style="margin-left:20px;"><strong>Rating</strong></div                        ></td>
    ...
    %>
	  ...
	  while(rs4.next())
	  {
	   ...
	   %>
	   <tr>
	  <td  width="227" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Reviewed By</strong></div></td>
     <td  width="164" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Review</strong></div></td>
	 <td  width="175" height="30" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style22 style21" style="margin-left:20px;"><strong>Date</strong></div></td>
	   </tr>
	   <%
	   }
	   %> 
     ...
     <td width="164"><span class="style21"></td>
	 <td width="175"><span class="style21"></td>
	   </tr>
	   <%
          ...
          <p>&nbsp;</p>
          <p align="right"><a href="admin_All_Reviewed_Posts.jsp">Back</a></p>
          <div class="clr"></div>
        </div>
        <div class="article">
